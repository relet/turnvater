...
var i18n = map[string]map[string]string{
	"de": {
		...
		"fail-power":           "Zu viele Gruppen für, Anzahl wird reduziert auf %d. Überzählige Spieler werden zusätzlich gruppiert.",
	...
	"en": {
		...
		"fail-power":           "Too many groups for, number is reduced to %d. Surplus players are grouped additionally.",
